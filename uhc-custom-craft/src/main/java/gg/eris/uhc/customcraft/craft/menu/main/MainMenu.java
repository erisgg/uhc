...
public final class MainMenu extends Menu {
  ...
  public MainMenu(UhcPlugin plugin) {
    ...
    addItem(11, new KitShopItem(this.kitMenu = new KitMenu(plugin, this)));
    addItem(13, new VocationShopItem(this.vocationShopMenu = new VocationShopMenu(plugin, this)));
    addItem(15, new UltimateShopItem(this.ultimateShopMenu = new UltimateShopMenu(plugin, this)));
  }
